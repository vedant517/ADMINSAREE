...
function TextInput({ style: extra, className: extraCls, ...props }) {
  ...
  return (
    <input
      {...props}
      className={`w-full text-[13px] px-3 py-2 border rounded-lg bg-[#fafafa] text-[#222] outline-none transition-all box-border ${focused ? 'border-blue-400 shadow-[0_0_0_3px_rgba(59,130,246,0.10)] bg-white' : 'border-[#e8e8e8]'} ${extraCls || ''}`}
      style={extra}
  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full text-[13px] px-3 py-2 border rounded-lg bg-[#fafafa] text-[#222] outline-none transition-all box-border pr-8 ${focused ? 'border-blue-400 shadow-[0_0_0_3px_rgba(59,130,246,0.10)] bg-white' : 'border-[#e8e8e8]'}`}
        onFocus={() => setFocused(true)}
        onBlur={() => setFocused(false)}
      />
      <button
  ...
  const AvatarEl = ({ size = 56 }) =>
    form.profileImageUrl ? (
      <img
        ...
        alt="avatar"
        className="rounded-full object-cover border-[2.5px] border-white shadow-[0_0_0_1px_#e0e7ff]"
        style={{ width: size, height: size }}
      />
    ) : (
      <div
        className="rounded-full bg-gradient-to-br from-blue-100 to-blue-200 text-blue-700 flex items-center justify-center font-bold flex-shrink-0 border-[2.5px] border-white shadow-[0_0_0_1px_#e0e7ff]"
        ...
        <div className="flex flex-col gap-3.5">
          ...
          <div className="bg-white rounded-2xl border border-[#ebebeb] px-5 py-5">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="bg-transparent text-blue-500 border-0 text-xs cursor-pointer p-0 font-medium">Need help?</button>
            </div>
            ...
            <button className="bg-transparent border-0 text-blue-500 text-[11px] cursor-pointer p-0 font-medium mt-1.5 block">Forgot password?</button>
            ...
            <button
              className="w-full mt-4 py-2.5 bg-green-700 text-white border-0 rounded-lg text-[13px] font-semibold cursor-pointer transition-opacity hover:opacity-90 disabled:opacity-70"
        ...
        <div className="bg-white rounded-2xl border border-[#ebebeb] px-5 py-5">
          ...
          <div className="flex items-center gap-3 mb-1.5">
            ...
            <div className="flex items-center gap-2.5 flex-1">
              ...
              <button
                type="button"
                className="bg-blue-600 text-white border-0 rounded-lg text-xs font-semibold px-3.5 py-2 whitespace-nowrap cursor-pointer hover:bg-blue-700 transition-colors"
          ...
          <div className="flex justify-end mt-5 pt-4 border-t border-[#f0f0f0] gap-2.5">
            ...
            <button
              className="bg-blue-600 text-white border-0 rounded-lg text-[13px] font-semibold min-w-[130px] py-2 cursor-pointer hover:bg-blue-700 transition-colors disabled:opacity-70"
              onClick={handleUpdate}
              disabled={saving}
            >
