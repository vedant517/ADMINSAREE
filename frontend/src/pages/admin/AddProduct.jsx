    ...
    <>
      <style>{`
        ...
        @media (min-width: 480px) {
          .ap-topbar-actions { flex-direction: row; align-items: center; }
        }
        ...
        @media (min-width: 480px) { .ap-search { width: 220px; } }
        ...
        /* ── Right column sticky only on desktop ── */
        .ap-right-col {
          display: flex;
          flex-direction: column;
          gap: 20px;
        ...
        @media (min-width: 1024px) {
          .ap-right-col { position: sticky; top: 24px; }
        }
        ...
        @media (min-width: 480px) {
          .ap-price-grid { grid-template-columns: 1fr 1fr; }
        }
        ...
        @media (min-width: 480px) {
          .ap-inv-grid { grid-template-columns: 1fr 1fr; }
        }
      `}</style>
      ...
      <div className="ap-root">
          ...
          <div className="ap-topbar-actions">
            <div className="ap-search">
              <input type="text" placeholder="Search product metadata..."
                style={{ ...inputStyle, paddingLeft: '36px', paddingRight: '16px', width: '100%' }} />
        ...
        {/* ── Error ── */}
        {error && (
          <div style={{ margin: '0 16px 16px', padding: '12px 16px', background: '#fef2f2', border: '1px solid #fee2e2', borderRadius: '12px', color: '#b91c1c', fontSize: '14px', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '8px' }}>
            <X size={16} /> {error}
          </div>
        )}

        {/* ── Form ── */}
        <form id="main-form" onSubmit={handleSubmit} className="ap-form">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div style={sectionStyle}>
              <h2 style={{ fontSize: '14px', fontWeight: 800, color: '#1e293b', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px', margin: '0 0 20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <textarea required name="description" rows={5} value={formData.description} onChange={handleInputChange}
            ...
            <div style={sectionStyle}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <button type="button" onClick={addVariant}
                  style={{ fontSize: '12px', fontWeight: 700, color: '#4c9f70', background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}>
                  <Plus size={14} /> Add Variant
                </button>
              </div>
              {variants.length === 0 ? (
                <div style={{ padding: '28px', textAlign: 'center', border: '2px dashed #f1f5f9', borderRadius: '12px' }}>
                  <p style={{ fontSize: '12px', color: '#94a3b8', margin: 0 }}>No variants added. (e.g., Color, Fabric, Price)</p>
                </div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {variants.map((variant, idx) => (
                    <div key={idx} style={{ background: '#f8fafc', padding: '16px', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <div className="ap-variant-grid">
                        ...
                        <button type="button" onClick={() => removeVariant(idx)}
                          style={{ padding: '8px', color: '#fca5a5', background: 'none', border: 'none', cursor: 'pointer', alignSelf: 'flex-end' }}>
                          <X size={16} />
                        </button>
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          style={{ width: '100%', padding: '10px 14px', background: 'white', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '13px', outline: 'none', boxSizing: 'border-box' }}
                        />
                      </div>
                    </div>
                  ))}
            ...
            {/* Pricing */}
            <div style={sectionStyle}>
              <h2 style={{ fontSize: '14px', fontWeight: 800, color: '#1e293b', marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.04em', margin: '0 0 20px' }}>Pricing</h2>
            ...
            <div style={sectionStyle}>
              ...
              <div className="ap-inv-grid">
                ...
                <div>
                  ...
                  <div style={{ position: 'relative' }}>
                    <select name="stockStatus" value={formData.stockStatus} onChange={handleInputChange}
          ...
          <div className="ap-right-col">
            ...
            {/* Media */}
            <div style={sectionStyle}>
              <h2 style={{ fontSize: '14px', fontWeight: 800, color: '#1e293b', marginBottom: '20px', margin: '0 0 20px' }}>Product Media</h2>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div
            ...
            {/* Organization */}
            <div style={sectionStyle}>
              <h2 style={{ fontSize: '14px', fontWeight: 800, color: '#1e293b', marginBottom: '20px', margin: '0 0 20px' }}>Organization</h2>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                    {(formData.mainCategory
                      ...
                      <button key={cat} type="button" onClick={() => handleCategoryToggle(cat)}
                        style={{ padding: '6px 12px', borderRadius: '8px', fontSize: '12px', fontWeight: 700, cursor: 'pointer', transition: 'all 0.15s', background: formData.categories?.includes(cat) ? '#0f172a' : 'white', color: formData.categories?.includes(cat) ? 'white' : '#94a3b8', border: '1px solid ' + (formData.categories?.includes(cat) ? '#0f172a' : '#e2e8f0') }}>
                        {cat}
                      </button>
                    ))}
                  </div>
