    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-5 font-sans text-slate-800 w-full overflow-x-hidden">
      ...
      <div className="flex justify-between items-center mb-5 gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          <div className="w-11 h-6 bg-green-100 rounded-xl flex items-center p-0.5 cursor-pointer">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
            <div className="hidden sm:flex flex-col text-right">
              ...
              <p className="text-[10px] text-[#4c9f70] font-semibold mt-0.5 mb-0">Verified</p>
            </div>
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#4c9f70] to-[#3a895c] flex items-center justify-center text-white font-bold text-base shrink-0 cursor-pointer border-2 border-white">
              A
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mb-3.5">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 min-w-0">
          <div className="flex justify-between items-start mb-3">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-800 m-0">Total Sales</p>
              <p className="text-[11px] text-slate-400 mt-0.5 mb-0">Overall Revenue</p>
            </div>
          ...
          <div className="flex items-baseline gap-1.5 flex-wrap mb-3">
            ...
            <span className="text-[11px] font-bold text-emerald-500 shrink-0">Revenue Net Total</span>
          </div>
          <div className="flex justify-between items-center gap-2">
            <p className="text-[11px] text-slate-400 m-0 truncate">Total completed transactions</p>
            <button className="px-3 py-1 border border-blue-200 text-blue-500 bg-transparent text-[11px] font-semibold rounded-2xl cursor-pointer shrink-0">Details</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 min-w-0">
          <div className="flex justify-between items-start mb-3">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-800 m-0">Total Orders</p>
              <p className="text-[11px] text-slate-400 mt-0.5 mb-0">Lifetime Activity</p>
            </div>
            <button className="bg-transparent border-none cursor-pointer text-slate-400 shrink-0 ml-2"><MoreVertical size={15} /></button>
          </div>
          <div className="flex items-baseline gap-1.5 flex-wrap mb-3">
            <span className="text-xl font-bold text-slate-800">{statsLoading ? '...' : statsData?.total || 0}</span>
            <span className="text-[11px] font-bold text-emerald-500 shrink-0">order +{statsData?.pending || 0} new</span>
          </div>
          <div className="flex justify-between items-center gap-2">
            <p className="text-[11px] text-slate-400 m-0 truncate">Total processed orders</p>
            <button className="px-3 py-1 border border-blue-200 text-blue-500 bg-transparent text-[11px] font-semibold rounded-2xl cursor-pointer shrink-0">Details</button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 flex flex-col min-w-0">
          <div className="flex justify-between items-start mb-3">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-800 m-0">Pending &amp; Canceled</p>
              <p className="text-[11px] text-slate-400 mt-0.5 mb-0">Direct attention items</p>
            </div>
            <button className="bg-transparent border-none cursor-pointer text-slate-400 shrink-0 ml-2"><MoreVertical size={15} /></button>
          </div>
          <div className="flex items-center gap-3 mb-3">
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-semibold text-slate-500 m-0">Pending</p>
              <div className="flex items-baseline gap-1 mt-1 flex-wrap">
                <span className="text-lg font-bold text-slate-800">{statsLoading ? '...' : statsData?.pending || 0}</span>
                <span className="text-[10px] text-slate-400">Need processing</span>
              </div>
            </div>
            <div className="w-px h-8 bg-slate-200 shrink-0"></div>
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-semibold text-slate-500 m-0">Canceled</p>
              <div className="flex items-baseline gap-1 mt-1 flex-wrap">
                <span className="text-lg font-bold text-slate-800">{statsLoading ? '...' : statsData?.cancelled || 0}</span>
                <span className="text-[10px] text-slate-400">Lost revenue</span>
              </div>
            </div>
          </div>
          <div className="flex justify-end mt-auto">
            <button className="px-3 py-1 border border-blue-200 text-blue-500 bg-transparent text-[11px] font-semibold rounded-2xl cursor-pointer">Details</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5 mb-3.5">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-4 border border-slate-200 flex flex-col min-w-0 overflow-hidden">
          <div className="flex justify-between items-center mb-3.5 gap-2 flex-wrap">
            <p className="text-[13px] font-extrabold text-slate-800 m-0">Report for this week</p>
            <div className="flex items-center gap-2 flex-shrink-0">
              <div className="flex border border-green-100 rounded-2xl p-0.5 bg-white">
                <button className="px-2.5 py-0.5 text-[11px] font-bold text-[#4c9f70] bg-green-50 rounded-2xl border-none cursor-pointer">This week</button>
          ...
          <div className="grid grid-cols-5 gap-1.5 mb-3.5">
            {[
              ...
              <div key={i} className={`pb-2 min-w-0 ${stat.active ? 'border-b-2 border-[#4c9f70] bg-green-50/50' : 'border-b-2 border-slate-100'}`}>
                <div className="px-1">
                  <div className="text-[13px] font-bold text-slate-800 truncate">{stat.val}</div>
                  <div className="text-[9px] text-slate-400 mt-0.5 font-bold uppercase tracking-[0.04em] truncate">{stat.name}</div>
                </div>
              </div>
            ))}
          </div>
                ...
                <Tooltip
                  ...
                  content={({ active, payload, label }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="bg-[#aee0b9] text-gray-800 text-[11px] font-bold px-2.5 py-1.5 rounded-lg text-center shadow">
        ...
        <div className="flex flex-col gap-3.5 min-w-0">
          <div className="bg-white rounded-2xl p-4 border border-slate-200">
            <div className="flex justify-between items-start mb-1">
              <div className="min-w-0 flex-1">
                <p className="text-[11px] font-bold text-blue-500 m-0">Users in last 30 minutes</p>
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 flex-1 flex flex-col min-w-0">
            ...
            <button className="w-full mt-3 py-1.5 border border-blue-200 text-blue-500 bg-transparent text-[11px] font-semibold rounded-2xl cursor-pointer">
              View Insight
            </button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5 mb-3.5">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-4 border border-slate-200 flex flex-col min-w-0 overflow-hidden">
          <div className="flex justify-between items-center mb-3.5 gap-2 flex-wrap">
            <p className="text-[13px] font-bold text-slate-800 m-0">Transaction</p>
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#4c9f70] text-white text-[11px] font-medium rounded-lg border-none cursor-pointer shrink-0">
                  ...
                  <tr key={row._id} className="border-t border-slate-50">
                    ...
                    <td className="py-2.5 pr-2">
                      <div className="flex items-center gap-1.5 text-[11px] font-bold">
                        <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${row.status === 'Delivered' ? 'bg-emerald-500' : row.status === 'Cancelled' ? 'bg-rose-500' : 'bg-amber-400'}`}></span>
                        {row.status}
                      </div>
                    </td>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 min-w-0">
          <div className="flex justify-between items-center mb-3">
            <p className="text-xs font-bold text-slate-800 m-0 truncate flex-1">Top Products (This Week)</p>
            <span className="text-[10px] text-blue-500 cursor-pointer font-semibold shrink-0 ml-2">All product</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5">
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-4 border border-slate-200 flex flex-col min-w-0 overflow-hidden">
          <div className="flex justify-between items-center mb-3.5 gap-2 flex-wrap">
            <p className="text-[13px] font-bold text-slate-800 m-0">Best selling product</p>
            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#4c9f70] text-white text-[11px] font-medium rounded-lg border-none cursor-pointer shrink-0">
              Filter <Filter size={11} />
            </button>
          </div>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 flex flex-col min-w-0">
          <div className="flex justify-between items-center mb-3">
            <p className="text-xs font-bold text-slate-800 m-0">Add New Product</p>
            <button className="text-[11px] text-blue-500 flex items-center gap-1 font-semibold bg-transparent border-none cursor-pointer shrink-0">
            ...
            {displayProducts.slice(0, 3).map((p, i) => (
              <div key={p._id || i} className="flex justify-between items-center gap-2 min-w-0">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="text-[11px] font-bold text-slate-800 truncate">{p.name}</div>
                    <div className="text-[10px] font-bold text-[#4c9f70]">{formatINR(p.price)}</div>
                  </div>
                </div>
                <button className="flex items-center gap-0.5 px-2.5 py-1 rounded-md bg-[#4c9f70] text-white border-none cursor-pointer text-[10px] font-semibold shrink-0">
                  <Plus size={8} strokeWidth={3} /> Add
                </button>
              </div>
            ))}
            <div className="text-center pt-1">
              <button className="text-[10px] text-blue-500 font-semibold bg-transparent border-none cursor-pointer">See more</button>
            </div>
          </div>
        </div>
      </div>
