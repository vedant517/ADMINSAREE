...
const OfferPage = () => {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-slate-50">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-slate-200 border-t-[#4c9f70] rounded-full mx-auto mb-4 animate-spin"></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-slate-50 px-6 py-7 font-sans text-slate-800">
      ...
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 bg-gradient-to-br from-[#4c9f70] to-[#3a895c] text-white border-0 px-5 py-2.5 rounded-xl font-bold text-sm cursor-pointer shadow-lg shadow-green-400/30 hover:opacity-90 transition-opacity"
        >
              ...
              >
                ...
                {offer.tag && (
                  <div className={`absolute top-3 right-3 z-10 text-white text-xs font-extrabold px-2.5 py-1 rounded-full ${
                    ...
                    offer.tag === "SALE" ? "bg-gradient-to-br from-[#4c9f70] to-[#3a895c]" :
                ...
                <div className="p-4 pb-5">
                  <div className="flex items-center gap-1 mb-2 flex-wrap">
                    <span className="text-xs font-bold text-[#4c9f70] bg-green-50 px-2 py-0.5 rounded-full border border-green-200">
                      {offer.mainCategory}
                    </span>
                    {offer.tags.map(tag => (
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div>
                      <div className="flex items-baseline gap-2">
                        <span className="text-xl font-extrabold text-[#4c9f70]">₹{finalPrice.toLocaleString()}</span>
      ...
      {showForm && (
        ...
        >
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto" style={{ animation: "slideUp 0.25s ease" }}>
            {/* Modal Header */}
            <div className="bg-gradient-to-br from-[#4c9f70] to-[#3a895c] px-6 py-5 flex justify-between items-center sticky top-0 z-10">
              <div>
            ...
            <div className="p-6">
              ...
              <div className="mb-3.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 border-[1.5px] border-slate-200 rounded-xl text-sm text-slate-800 outline-none bg-slate-50 cursor-pointer focus:border-[#4c9f70] transition-colors"
                >
              ...
              <div className="mb-3.5">
                ...
                <input
                  ...
                  value={formData.name}
                  onChange={handleChange}
                  className="w-full px-3.5 py-2.5 border-[1.5px] border-slate-200 rounded-xl text-sm text-slate-800 outline-none bg-slate-50 focus:border-[#4c9f70] transition-colors"
                />
              </div>
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowForm(false)}
                  className="flex-1 py-2.5 border-[1.5px] border-slate-200 rounded-xl bg-white text-slate-500 font-bold cursor-pointer hover:bg-slate-50 transition-colors"
                >
                  Cancel
                </button>
                <button
                  onClick={handleCreateOffer}
                  className="flex-[2] py-2.5 border-0 rounded-xl bg-gradient-to-br from-[#4c9f70] to-[#3a895c] text-white font-bold cursor-pointer hover:opacity-90 transition-opacity"
                >
                  ✓ Create Offer
                </button>
              </div>
