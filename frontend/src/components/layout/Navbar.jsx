...
const Navbar = () => {
  ...
  const { isCustomerLoggedIn, cartCount } = useCustomerSession();

  const displayCartCount = isCustomerLoggedIn ? cartCount : 0;
          ...
          <div className="px-4 pt-2 pb-6 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-6 pt-4 border-t border-white/5">
              <Link to="/cart"  className="flex items-center gap-2 text-slate-300 no-underline text-[15px]">
                <ShoppingCart size={20} /><span>Cart ({displayCartCount})</span>
              </Link>
